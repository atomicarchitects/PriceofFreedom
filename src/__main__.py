...
from src.tetris import train as tetris_train
...
def main(argv):
    ...
    # Add the tensor product config to the main config.
    FLAGS.config.tensor_product = FLAGS.tensor_product_config
    ...
    # Start training!
    if FLAGS.config.dataset == "tetris":
        tetris_train.train_and_evaluate(FLAGS.config, FLAGS.workdir)
    else:
