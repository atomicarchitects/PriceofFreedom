...
do
    ...
    do
        ...
        do
            ...
            python -m utils.run_profiler benchmark_tp.py profiles/nsight_${irreps_type}_${tp_type}_${lmax}.csv --tensor_product_type=$tp_type --irreps_type=$irreps_type --lmax=$lmax --ncu_flag=True
        done
    done
done

python -m utils.postprocess --profiles_path="profiles"
rm -rf /tmp/jax_cache