...
csv_file="benchmarking/csv/walltime_cpu.csv"
...
do
    ...
    do
        ...
        do
            ...
            do
                python -m benchmarking --tensor_product_type=$tp_type --irreps_type=$irreps_type --lmax=$lmax --batch=$batch --device=cpu --walltime_file=$csv_file --device=cpu
            done
        done
    done
done
